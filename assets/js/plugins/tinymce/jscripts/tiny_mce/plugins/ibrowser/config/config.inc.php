...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> '/diabaticclone/multimedias/images/template_images',												
			'text'    	=> 'Site Pictures',
		)	
	);
	//-------------------------------------------------------------------------
	...
	$cfg['ilibs_dir'] 	   = array('/diabaticclone/multimedias/images/template_images');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
