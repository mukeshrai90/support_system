...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2017 at 09:44 PM
...
(1, 'Admin', 'admin', 'admin@admin.com', '', 'e10adc3949ba59abbe56e057f20f883e', '', '', '', '', 1, '2017-10-01 00:23:26', '2017-09-07 00:00:00', '2017-09-07 00:00:00'),
(3, 'Admin', 'admin1', 'admin1@admin.com', '9999999999', 'e0ec043b3f9e198ec09041687e4d4e8d', '9999999999', NULL, '', '', 1, '0000-00-00 00:00:00', '2017-09-12 00:24:18', '2017-10-01 01:00:51');
...
(2, 3, 3, 1, 2, 2, '2017-09-12 00:10:09'),
(3, 3, 3, 1, 2, 2, '2017-10-01 01:00:36');
...
CREATE TABLE `bs_afe_commissions` (
  ...
  `commission_year` tinyint(4) NOT NULL,
...
CREATE TABLE `bs_afe_commission_status` (
  ...
  `previous_status_id` int(2) NOT NULL,
...
--
ALTER TABLE `bs_admin_call_logs`
  MODIFY `call_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `bs_afe_commissions`
  MODIFY `commission_id` bigint(11) NOT NULL AUTO_INCREMENT;
--
