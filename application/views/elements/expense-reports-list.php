	...
	<tbody>
		...
		?>
			<tr class="">
				...
				<td><?php echo $ticket['device_id'] != '' ? $ticket['device_id'].'<br/>'.$ticket['device_name'] : 'NA';?></td>
				...
				<td class="tooltip-demo">
					<a href="<?php echo BASE_URL.'expense-reports/view/'.$ticket_id.'?device_id='.$ticket['device_id']?>" title="View" class="actions-a" data-toggle="tooltip" data-placement="bottom">
