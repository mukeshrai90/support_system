		...
		?>
			<tr class="">				
				...
				<td class="tooltip-demo">
					...
					?>
						<a href="<?php echo BASE_URL.'incentives/fe/view/leads?month='.$month.'&year='.$year.'&fe='.EnCrypt($rcd['admin_id'])?>" title="View" class="actions-a" data-toggle="tooltip" data-placement="bottom">
