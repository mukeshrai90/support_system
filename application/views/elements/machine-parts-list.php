	...
	<tbody>
		...
		?>
			<tr class="">
				...
				<td class="tooltip-demo">										
					<a href="<?php echo BASE_URL.'machine-parts/edit/'.$record['id']?>" title="Edit" class="actions-a" data-toggle="tooltip" data-placement="bottom">
						<i class="fa fa-pencil-square-o text-navy"></i>
					</a>				
					<a href="<?php echo BASE_URL.'home/delete_machine_parts/'.$record['id']?>" title="Delete" class="actions-a" data-toggle="tooltip" data-placement="bottom" onclick="if(!confirm('Are you sure to delete?')){return false;}">
